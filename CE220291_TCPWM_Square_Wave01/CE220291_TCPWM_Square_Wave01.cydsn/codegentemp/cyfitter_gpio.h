...
/* ULF_nBO */
#define ULF_nBO_0_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define ULF_nBO_0_INBUF_ENABLED 0u
#define ULF_nBO_0_INIT_DRIVESTATE 0u
#define ULF_nBO_0_INIT_MUXSEL 0u
#define ULF_nBO_0_INPUT_SYNC 2u
#define ULF_nBO_0_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define ULF_nBO_0_NUM 5u
#define ULF_nBO_0_PORT GPIO_PRT10
#define ULF_nBO_0_SLEWRATE CY_GPIO_SLEW_FAST
#define ULF_nBO_0_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
#define ULF_nBO_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define ULF_nBO_INBUF_ENABLED 0u
#define ULF_nBO_INIT_DRIVESTATE 0u
#define ULF_nBO_INIT_MUXSEL 0u
#define ULF_nBO_INPUT_SYNC 2u
#define ULF_nBO_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define ULF_nBO_NUM 5u
#define ULF_nBO_PORT GPIO_PRT10
#define ULF_nBO_SLEWRATE CY_GPIO_SLEW_FAST
#define ULF_nBO_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
